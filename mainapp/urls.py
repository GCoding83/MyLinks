...
urlpatterns = [ 
	...
	path('authors/<int:pk>/', AuthorDetailView.as_view(), name='author-detail-page'),
	path('publications/', PublicationListView.as_view(), name='publications-page'),
	path('publications/<int:pk>/', PublicationDetailView.as_view(), name='publication-detail-page'),
